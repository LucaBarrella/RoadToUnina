# ✉️ Bozza E-mail per Consegna Progetto (FileSender Unina)

Questa bozza è pronta da copiare e incollare direttamente su [FileSender Unina](https://filesender.unina.it/).

---

### 📋 Campi del Modulo FileSender
* **Destinatario:** `luigiliberolucio.starace@unina.it`
* **Oggetto:** `[TECWEB] Consegna progetto 25/26 N86004677 Luca Barrella`
* **File da caricare:** `N86004677-Luca-Barrella.zip`
* **Data di scadenza:** Impostare la data più lontana consentita dal portale (1 mese / 30 giorni)

---

### 📝 Testo del Messaggio (Copia & Incolla)

```text
Gentile Prof. Starace,

Con la presente invio l'elaborato progettuale per l'esame di Tecnologie Web (A.A. 2025/2026).

- Candidato: Luca Barrella
- Matricola: N86004677
